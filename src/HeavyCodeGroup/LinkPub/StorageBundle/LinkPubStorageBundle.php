    ...
    public function boot()
    {
        ...
        if (!Type::hasType(PageStatusType::ENUM_PAGE_STATUS)) {
            Type::addType(
                ...
                'HeavyCodeGroup\LinkPub\StorageBundle\Doctrine\DBAL\PageStatusType'
            );
        }
        ...
        if (!Type::hasType(LinkStatusType::ENUM_LINK_STATUS)) {
            Type::addType(
                ...
                'HeavyCodeGroup\LinkPub\StorageBundle\Doctrine\DBAL\LinkStatusType'
            );
        }
        ...
        if (!Type::hasType(LinkProblemType::ENUM_LINK_PROBLEM)) {
            Type::addType(
                ...
                'HeavyCodeGroup\LinkPub\StorageBundle\Doctrine\DBAL\LinkProblemType'
            );
        }
        ...
        if (!Type::hasType(ConsumerStatusType::ENUM_CONSUMER_STATUS)) {
            Type::addType(
                ...
                'HeavyCodeGroup\LinkPub\StorageBundle\Doctrine\DBAL\ConsumerStatusType'
            );
        }
    }
